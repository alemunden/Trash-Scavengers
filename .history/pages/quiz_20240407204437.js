        ...
        <div className={styles.container}>
            ...
            <div className={styles.quizList}>
                {!showResult ? (<div className={styles.quizContainer}>
                    ...
                    {checked ? (<button onClick={nextQuestion} className='btn'>{activeQuestion === question.length - 1 ? 'Finish' : 'Next'}</button>) : (<button onClick={nextQuestion} disabled className={styles.btnDisabled}>{''}{activeQuestion === question.length - 1 ? 'Finish' : 'Next'}</button>)}
                </div>) : (
