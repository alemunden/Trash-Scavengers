...
export default function Info() {
    return(
        ...
        <main>
            ...
            <Link href="/InfoCompost">
                <button className={styles.readMoreButtonCompost}>Read More</button>
            </Link>
            <Link href="/InfoRecycling">
                <button className={styles.readMoreButtonRecycling}>Read More</button>
            </Link>
            <Link href="/InfoGarbage">
                <button className={styles.readMoreButtonGarbage}>Read More</button>
            </Link>
            <div class="infoCard">
